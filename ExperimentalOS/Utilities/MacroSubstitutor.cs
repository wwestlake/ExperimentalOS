/*
 * This file was taken from The Code Project by Author Steve Donovan
...
namespace LagDaemon.ExperimentalOS.Utilities
{
    ...
    internal class MacroEntry
    {
        ...
        internal string Subst;
        internal string[] Parms;
    }

    internal class MacroSubstitutor
    {
        Hashtable macroTable = new Hashtable();

        internal void AddMacro(string name, string subst, string[] parms)
        {
        ...
        internal MacroEntry Lookup(string s)
        {
        ...
        internal string ReplaceParms(MacroEntry me, string[] actual_parms)
        {
            Match m;
            int istart = 0;
        ...
        internal string Substitute(string str)
        {
            Match m;
            int istart = 0;
        ...
        internal virtual string CustomReplacement(string s)
        {
            return "";
        }
    }
