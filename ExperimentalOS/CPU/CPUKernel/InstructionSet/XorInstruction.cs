...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    /// </summary>
    [Serializable]
    internal class XorInstruction : MathBase
    {

        internal XorInstruction() : base(InstructionCodes.Xor) { }

        internal XorInstruction(int r1, int r2, int r3)
            : this(r1, r2, r3, string.Empty) { }

        internal XorInstruction(int r1, int r2, int r3, string comment)
            : base(InstructionCodes.Xor, r1, r2, r3, comment) { }

        internal XorInstruction(XorInstruction inst)
        ...
        {
            return factory.Xor(r1, r2, r3, comment);
        }
    }
}
