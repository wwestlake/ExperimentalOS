...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    /// </summary>
    [Serializable]
    internal class MulInstruction : MathBase
    {

        internal MulInstruction() : base(InstructionCodes.Mul) { }

        internal MulInstruction(int r1, int r2, int r3)
            : this(r1, r2, r3, string.Empty) {}

        internal MulInstruction(int r1, int r2, int r3, string comment)
            : base(InstructionCodes.Mul, r1, r2, r3, comment) {}

        internal MulInstruction(MulInstruction inst)
        ...
        {
            return factory.Mul(r1, r2, r3, comment);
        }
    }
}
