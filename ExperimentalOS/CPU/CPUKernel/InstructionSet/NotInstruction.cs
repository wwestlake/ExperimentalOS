...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    /// </summary>
    [Serializable]
    internal class NotInstruction : MathBase
    {

        internal NotInstruction() : base(InstructionCodes.Not) { }

        internal NotInstruction(int r1, int r2, int r3)
            : this(r1, r2, r3, string.Empty) { }

        internal NotInstruction(int r1, int r2, int r3, string comment)
            : base(InstructionCodes.Not, r1, r2, r3, comment) { }

        internal NotInstruction(NotInstruction inst)
        ...
        {
            return factory.Not(r1, r2, r3, comment);
        }
    }
}
