...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    /// </summary>
    [Serializable]
    internal class DecInstruction : Instruction
    {
        internal int r1;
        ...
        internal DecInstruction(int r1, string comment)
            : base(InstructionCodes.Dec, comment)
        {
            this.r1 = r1;
            Size = 2;
        }
        ...
        /// </summary>
        /// <param name="r1">register</param>
        internal DecInstruction(int r1) : this(r1, string.Empty) { }
