...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    internal class ReturnInstruction : Instruction
    {
        ...
        /// </summary>
        internal ReturnInstruction() : this(string.Empty) { }

        /// <summary>
        /// Constructs a NOP instruction
        /// </summary>
        /// <param name="comment">Comment</param>
        internal ReturnInstruction(string comment) : base(InstructionCodes.Return, comment) { this.Size = 1; }

        /// <summary>
        /// Copy constructor
        /// </summary>
        /// <param name="inst">The NopInstruction to copy</param>
        internal ReturnInstruction(NopInstruction inst)
            : this(string.Empty)
        {
        }
