...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    /// </summary>
    [Serializable]
    internal class OrInstruction : MathBase
    {

        internal OrInstruction() : base(InstructionCodes.Or) { }

        internal OrInstruction(int r1, int r2, int r3)
            : this(r1, r2, r3, string.Empty) { }

        internal OrInstruction(int r1, int r2, int r3, string comment)
            : base(InstructionCodes.Or, r1, r2, r3, comment) { }

        internal OrInstruction(OrInstruction inst)
        ...
        {
            return factory.Or(r1, r2, r3, comment);
        }
    }
}
