...
namespace LagDaemon.ExperimentalOS.CPU.CPUKernel.InstructionSet
{
    ...
    /// </summary>
    [Serializable]
    internal class SubInstruction : MathBase
    {
        internal SubInstruction() : base(InstructionCodes.Sub) { }

        internal SubInstruction(int r1, int r2, int r3)
            : this(r1, r2, r3, string.Empty) {}

        internal SubInstruction(int r1, int r2, int r3, string comment)
            : base(InstructionCodes.Sub, r1, r2, r3, comment) {}

        internal SubInstruction(SubInstruction inst)
        ...
        {
            return factory.Sub(r1, r2, r3, comment);
        }
    }
}
